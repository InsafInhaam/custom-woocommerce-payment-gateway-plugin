...
/**
 * Payleo Mobile Payment Gateway.
 *
 * Provides a Payleo Mobile Payment Gateway.
 *
...
class WC_Gateway_Payleo extends WC_Payment_Gateway
{
    ...
    protected function setup_properties()
    {
        ...
        $this->method_title = __('Payleo Mobile Payment', 'payleo-payments-woo');
        $this->method_description = __('Use your mobile payments to clear the bill.', 'payleo-payments-woo');
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'label' => __('Enable Payleo Mobile Payment', 'payleo-payments-woo'),
                'type' => 'checkbox',
                'description' => '',
                'default' => 'no',
            ),
            'title' => array(
                ...
                'type' => 'safe_text',
                'description' => __('Payleo payment method description that the customer will see on your checkout.', 'payleo-payments-woo'),
                'default' => __('Payleo Mobile Payment', 'payleo-payments-woo'),
                'desc_tip' => true,
            ),
            'description' => array(
                'title' => __('Description', 'payleo-payments-woo'),
                'type' => 'textarea',
                'description' => __('Payleo payment method description that the customer will see on your website.', 'payleo-payments-woo'),
                'default' => __('Pay with mobile cash balance.', 'payleo-payments-woo'),
                'desc_tip' => true,
            ),
            'instructions' => array(
                ...
                'default' => __('Pay with your mobile cash balance.', 'payleo-payments-woo'),
                'desc_tip' => true,
            ),
            ...
            'enable_for_virtual' => array(
                ...
                'label' => __('Accept COD if the order is virtual', 'payleo-payments-woo'),
                'type' => 'checkbox',
                'default' => 'yes',
            ),
        );
    ...
    public function process_payment($order_id)
    {
        ...
        if ($order->get_total() > 0) {
            ...
            $order->update_status(apply_filters('woocommerce_cod_process_payment_order_status', $order->has_downloadable_item() ? 'on-hold' : 'processing', $order), __('Payment to be made upon delivery.', 'payleo-payments-woo'));
        } else {
