	...
	if (class_exists(('WC_Payment_Gateway'))) {
		...
		class WC_Gateway_Payleo extends WC_Payment_Gateway
		{
			...
			protected function setup_properties()
			{
				...
				$this->method_title = __('Payleo Mobile Payment', 'woocommerce');
			...
			public function init_form_fields()
			{
				$this->form_fields = array(
					'enabled' => array(
						...
						'label' => __('Enable Payleo Mobile Payment', 'woocommerce'),
						'type' => 'checkbox',
						'description' => '',
						'default' => 'no',
					),
					'title' => array(
						...
						'default' => __('Payleo Mobile Payment', 'woocommerce'),
						'desc_tip' => true,
					),
					'description' => array(
						'title' => __('Description', 'woocommerce'),
						'type' => 'textarea',
						'description' => __('Payleo payment method description that the customer will see on your website.', 'woocommerce'),
						'default' => __('Pay with mobile cash balance.', 'woocommerce'),
						'desc_tip' => true,
					),
					'instructions' => array(
					...
					'enable_for_methods' => array(
						...
						'css' => 'width: 400px;',
						'default' => '',
						'description' => __('If Payleo is only available for certain methods, set it up here. Leave blank to enable for all methods.', 'woocommerce'),
